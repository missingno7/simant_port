...
flowchart TD
  ...
  class gmap,ihole,ifood,ipeb,gdis done;
  class iva,idirt,iyel,srand load;
  class das,dab,daa,dnb,dfor,gbd,ddig,glife,inobs front;
```
...
|---------|--------|------|:---------:|
| `seg5` | SIMONE | sim primitives — map, life-grid, RNG, predicates | 29 / 169 |
