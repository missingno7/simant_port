...
flowchart TD
  ...
  class tmdb,gob done;
  class dfa,ddoa,gnm,dah,gw,sfa done;
...
| `seg6` | SIMANT1 | ant AI — lists/scent/mode-pop/pathfinding/**movement done**; `_DoFightA`/`_DoDigOutAntA`/`_GetWinner`/`_StartFightA` done; forage/nest frontier | 41 / 123 | movement **done** |
